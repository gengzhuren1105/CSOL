...
<head>
    ...
    <link rel="stylesheet" href="css/jsversion.css">
</head>
...
<body>
    ...
    <section class="wrapper">
        ...
        <section class="path">
            <div>
                <img src="images/theme-data.png" alt="">
            </div>
            <div>
                <p>您的位置：<a href="index.php">首页</a>>游戏资料>角色介绍</p>
            </div>
        </section>
        <main class="clearfix">
            <ul>
            ...
            <div class="content">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "
                    <div class='content1'>
                    <img src='images/banben/$tu'>
                    <div class='content2'>
                    <p class='name'>$name <a>发布时间：$date</a></p>
                    <hr>
                    <p class='jie'>$jieshao</p>
                    </div>
                    </div>
                    ";
                }
