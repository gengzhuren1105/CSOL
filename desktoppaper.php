...
<head>
    ...
    <link rel="stylesheet" href="css/desktoppaper.css">
</head>
...
<body>
    ...
    <section class="wrapper">
        ...
        <section class="path">
            ...
            <div>
                <p>您的位置：<a href="index.php">首页</a>>下载中心>桌面壁纸</p>
            </div>
        </section>
        <main class="clearfix">
            <ul>
            ...
            <div class="content">
                ...
                $sql = "SELECT * FROM tupian ";
                $result = execute_sql($link, "csolbs", $sql);
                $z = mysqli_num_rows($result);
                echo "<table border='0' cellpadding='5px' align='center'>";
                $photo_per_row = 3;
                $i = 1;
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><img  style='border-color:Black;border-width:1pxwidth: 280px;height: 240px;' src='images/bizhi/$dishi'></td>";
                    if ($i % $photo_per_row == 0 || $i == $z) {
                        echo "</tr>";
                    }
                    $i++;
                }
