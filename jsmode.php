...
<head>
    ...
    <link rel="stylesheet" href="css/jsmode.css">
</head>
...
<body>
    ...
    <section class="wrapper">
        ...
        <section class="path">
            ...
            <div>
                <p>您的位置：<a href="index.php">首页</a>>游戏资料>版本介绍</p>
            </div>
        </section>
        <main class="clearfix">
            <ul>
            ...
            <div class="content">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <p class='moshi'>$moshi 介绍</p>
                    <p class='jieshao'>$jieshao</p>
                    <img src='images/moshi/$tu'>
                    </div>";
                }
                ?>
            </div>
