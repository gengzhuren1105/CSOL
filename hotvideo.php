...
<head>
    ...
    <link rel="stylesheet" href="css/hotvideo.css">
</head>
...
<body>
    ...
    <section class="wrapper">
        ...
        <section class="path">
            ...
            <div>
                <p>您的位置：<a href="index.php">首页</a>>下载中心>火爆视频</p>
            </div>
        </section>
        <main>
            <ul>
            ...
            <div class="content">
                ...
                echo "<table border='0' cellpadding='10px' align='center'>";
                $photo_per_row = 4;
                $i = 1;
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<div class='picbody'>";
                    echo "<td><img  style='border-color:Black;border-width:1px' src='images/shipin/$dishi'><p>$name</p></td>";
                    echo "</div>";
